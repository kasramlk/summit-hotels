-- Add super_admin role to user_hotels table
-- First, let's update the role column to allow 'super_admin' value
ALTER TABLE public.user_hotels DROP CONSTRAINT IF EXISTS user_hotels_role_check;
